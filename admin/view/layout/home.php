        ...
        <section class="statistics-section">
            <div class="row">
                <div class="col-xl-3 col-md-6">
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <h4 class="fs-22 fw-semibold ff-secondary my-3">$<span class="counter-value" data-target="559.25">0</span>k</h4>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-animate">
                        <div class="card-body">
                            <p class="text-uppercase fw-medium text-muted mb-0">Orders</p>
                            <h5 class="text-danger fs-14 mb-0">-3.57 %</h5>
                            <h4 class="fs-22 fw-semibold ff-secondary my-3"><span class="counter-value" data-target="36894">0</span></h4>
