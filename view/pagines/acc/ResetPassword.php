                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="newPassword" value="" placeholder="Enter Your Password" class="cr-form-control">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <label>Confirm Password*</label>
                                        <input type="password" name="confirmPassword" value="" placeholder="Re-enter Password" class="cr-form-control">
                                    </div>
                                </div>
                                ...
                                <div class="cr-register-buttons">
                                    <button type="submit" name="resetPass" value="resetPass" class="cr-button">Update Password</button>
                                </div>
                            </div>
                        </form>
                    </div>
